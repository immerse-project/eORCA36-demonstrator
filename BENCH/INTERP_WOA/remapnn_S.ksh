...
#SBATCH -o remapnn1.err
#SBATCH -e remapnn1.out
set -xv
...
#########################################################################
GRIDIN=$SCRATCH/ORCA36-IN/practical_salinity_WOA13_A5B2_Reg1L75_clim.nc
...
FO=$SCRATCH/ORCA36-IN/${CONF}_practical_salinity_WOA13_A5B2_Reg1L75_clim.nc
